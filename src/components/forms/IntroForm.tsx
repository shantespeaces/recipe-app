...
//     try {
//       // Submit Intro Section
//       let response = await axios.post("http://localhost:8000/api/recipes", {
//         name: recipeTitle,
//         imge: "",
//         description: description,
//         category_id: selectedCategory,
...
//       console.log("Intro Section Response:", response);
//       console.log("Error Object:", response.data.error);
//       // Get the recipe ID from the response
//       const createdRecipeId = response.data.success.insert_id;
//       console.log("Recipe ID:", createdRecipeId);
...
//       // // Include the image data in your axios request
...
//       // response = await axios.post(
//       //   `http://localhost:8000/api/recipes/${lastId}`,
//       //   {
//       //     image: `/img/recipes/${lastId}/512x512.jpg`,
//       //   }
//       // );
