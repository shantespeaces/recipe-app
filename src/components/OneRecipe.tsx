...
//     // const recipeId = localStorage.getItem("createdRecipeId");
...
//       axios
//         .get(`http://localhost:8000/api/subcategories/recipe_id/${id}`)
//         .then((response) => {
...
//       axios
//         .get(`http://localhost:8000/api/instructions/recipe_id/${id}`)
//         .then((response) => {
